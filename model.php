...
class Database
{
    private $host = "mysql:dbname=facturephp";
    private $user = "root";
    private $pswd = "";
    ...
    {
        $q = $this->getconnexion()->prepare("INSERT INTO factures (customer, cashier, amount, received, returned, state) VALUES (:customer, :cashier, :amount, :received, :returned, :state)");
        return $q->execute([
            'customer' => $customer,
            'cashier' => $cashier,
            'amount' => $amount,
